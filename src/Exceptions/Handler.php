...
class Handler extends IlluminateHandler
{
    ...
    protected function prepareException(Throwable $e): Throwable
    {
        return match (true) {
            ...
            $e instanceof AuthorizationException => static::httpException($e->status() ?? 403, $e, $e->getMessage() !== '' && $e->getMessage() !== 'This action is unauthorized.' ? $e->getMessage() : SymfonyResponse::$statusTexts[$e->status() ?? 403] ?? ''),
